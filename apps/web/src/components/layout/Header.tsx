        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2 items-center">
            ...
            <button
              ...
              className="px-2 py-1 bg-gray-700 text-white text-xs rounded hover:bg-gray-600 transition-colors w-10"
            ...
            {/* Кнопка справки */}
            <button 
              className="px-2 py-1 bg-green-600 text-white text-xs rounded hover:bg-green-700 transition-colors flex items-center w-24"
            ...
            {/* Кнопка настроек AI */}
            <button 
              className="px-2 py-1 bg-indigo-600 text-white text-xs rounded hover:bg-indigo-700 transition-colors flex items-center w-32"
            ...
            {user && (
              <>
                <span className="text-xs text-gray-300 px-2 max-w-[150px] truncate">{user.email}</span>
                <button 
                  className="px-2 py-1 bg-red-600 text-white text-xs rounded hover:bg-red-700 transition-colors flex items-center w-20"
                  onClick={logout}
