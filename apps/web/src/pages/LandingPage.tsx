      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="bg-gray-900 rounded-lg p-8 shadow-xl">
          <p className="text-gray-300 mb-6">
            {t('landing.description', 'Create, organize, and manage complex prompts for AI models')}
          </p>
          ...
          >
            ...
            {t('landing.signInWithGoogle', 'Sign in with Google')}
          </button>

          <p className="text-gray-500 text-sm mt-6">
            {t('landing.freeplan', 'Free plan: up to 10 projects')}
          </p>
        </div>
