// src/components/ui/FullscreenEditor.js
import React, { useRef, useEffect } from 'react';
import { useTranslation } from 'react-i18next';

const FullscreenEditor = ({ isOpen, onClose, onSave, title, content = '' }) => {
    ...
    >
      <div className="bg-gray-800 p-4 border-b border-gray-700 flex justify-between items-center">
        ...
        <button
          ...
          onClick={onClose}
          title={t('modals.fullscreenEditor.closeTooltip')}
        >
      ...
      <div className="bg-gray-800 p-4 border-t border-gray-700 flex justify-between items-center">
        <div className="text-sm text-gray-400">{text.length} {t('modals.fullscreenEditor.characters')}</div>
